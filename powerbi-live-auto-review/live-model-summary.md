...
- `IncidentsAllFields` (visible)
- `Contacts` (visible)
- `Calendar` (visible)
- `Time_Intelligence_KPI` (visible)
- `DateTableTemplate_cd6234f5-ed3b-41d9-80c6-5d2a3fd7d70b` (hidden)
- `LocalDateTable_b789e8be-b3bb-4cb5-8049-187548e505a7` (hidden)
- `LocalDateTable_04907eab-9f82-4bb2-ad4d-a0d4c0f57a2a` (hidden)
- `LocalDateTable_a3a8c179-d2b2-4522-ab34-12af17cca3a7` (hidden)
- `LocalDateTable_6179f5ec-568e-4523-99ef-59c009e4f758` (hidden)
- `LocalDateTable_3e7f9453-c899-431e-8d63-d2296754d07e` (hidden)
- `LocalDateTable_4163116a-fcd3-4f7a-badb-d31a261ad1dd` (hidden)
- `LocalDateTable_731be246-b15a-4ebc-a87d-da6bc92f4ceb` (hidden)
- `LocalDateTable_fd71077c-b8fe-4abd-b5dc-abdf88284d4c` (hidden)
- `LocalDateTable_b870afc0-9685-4e08-9dfc-a7640656fbeb` (hidden)
- `LocalDateTable_d8cb4dd0-757f-45ad-84be-b6390e8d7099` (hidden)
- `LocalDateTable_df7bf151-7e95-4aa9-a865-d5ec3435a58b` (hidden)
- `LocalDateTable_36adbf27-f7ed-4c71-a8bf-7b276b74c9bd` (hidden)
- `LocalDateTable_59c13864-aaac-49c3-b061-4d8a4c7de37a` (hidden)
- `LocalDateTable_d6cbdcfb-86e6-413f-8b3e-dda0b5ef4333` (hidden)
- `LocalDateTable_5671868b-d3f7-41c4-be7c-b1461e95694e` (hidden)
- `LocalDateTable_9d5e05e5-0c64-4072-9854-8f8996299127` (hidden)
- `LocalDateTable_da8ec622-0828-4763-89a8-49f675b0b222` (hidden)
- `LocalDateTable_155fc8af-530f-4337-b166-0fb25ac91130` (hidden)
- `LocalDateTable_9e3613e6-4f39-4abc-b7b6-2f1000898aee` (hidden)
- `LocalDateTable_18087325-a40c-4d5c-ad4d-c7378f9f1b0c` (hidden)
- `LocalDateTable_4d86cb56-21f8-4e22-ba9c-ad5e6ddd8b16` (hidden)
- `LocalDateTable_edd333f4-3667-465d-a2b9-5f86aaf1bd69` (hidden)
- `LocalDateTable_d400bad5-2ea9-4c5f-977b-8ed6bf9bb2ec` (hidden)
- `LocalDateTable_53166fb1-ca68-4c0e-92c8-2391b5f2705b` (hidden)
- `LocalDateTable_0ac2311f-75fa-49d9-a653-72cfc7ee6b7a` (hidden)
- `LocalDateTable_e8232640-15c2-4dbd-82d3-42aa39f35789` (hidden)
- `LocalDateTable_31284c9f-cdaa-4a9b-8c94-ce473de2e079` (hidden)
- `LocalDateTable_6a69fc52-e343-4259-ad06-40501055977e` (hidden)
- `LocalDateTable_2c431e31-8116-4cdc-8ff9-ac435aaf0ea2` (hidden)
- `LocalDateTable_710eb0c5-014e-4065-bf6b-469715a87c91` (hidden)
- `LocalDateTable_1ee5aad0-bdd9-4eb7-8a5f-44593b48336b` (hidden)
- `LocalDateTable_dfa0b335-dbf5-4097-9254-8b8666da765d` (hidden)
- `LocalDateTable_afbc5d0f-9bb2-4f6f-9510-706cefcb2a4c` (hidden)
- `LocalDateTable_0eb61b61-a77a-420f-9963-699ff81d28dc` (hidden)
- `LocalDateTable_a8818b7d-323a-42cc-82c3-552efd9eb4f5` (hidden)
- `LocalDateTable_c1630e9a-cab7-48e5-8b21-4597c030ba9c` (hidden)
- `LocalDateTable_21702a78-22ab-477b-9490-71882a796bc3` (hidden)
- `LocalDateTable_06dfa55a-7a9b-45ef-b4b5-d7a6971b686c` (hidden)
- `LocalDateTable_cf9230f6-82c9-4adb-a13d-2bad3880b547` (hidden)
- `LocalDateTable_5e904a3e-00f9-4cb1-966d-6b7aebbeebe2` (hidden)
- `LocalDateTable_818e8244-5dbd-46cc-8deb-aadfea2fc63a` (hidden)
- `LocalDateTable_ced54062-64d9-4444-869f-4e4de3f47717` (hidden)
- `LocalDateTable_f4a56a2b-cb07-45d4-803f-333f5230d314` (hidden)
- `LocalDateTable_054f03b9-6169-4675-873f-156d2b1dce10` (hidden)
- `LocalDateTable_af7722b7-c443-4810-8da7-e5a428a6e000` (hidden)
- `LocalDateTable_4a32cd3e-0c4e-40a1-967d-46d02b2f67f0` (hidden)
- `RecordTracker` (visible)
- `LocalDateTable_2d96a466-7f8c-4a2c-9ec1-a93798c51e45` (hidden)
- `LocalDateTable_00c56d1a-cd56-4462-95a8-609a14333646` (hidden)
- `LocalDateTable_313c6c06-ebac-4686-804b-e585c99e3766` (hidden)
- `LocalDateTable_dba8f024-aff2-4bd1-b078-05f2bd63771f` (hidden)
- `LocalDateTable_81ee5e2a-ee5f-4605-b626-7d692fd72d4e` (hidden)
- `LocalDateTable_83eea173-73c1-4496-837e-9ec4c967e6ad` (hidden)
- `LocalDateTable_26d8cbbd-17f4-44d6-a71a-f69b62ceae25` (hidden)
- `LocalDateTable_afe9761d-c9ed-4148-88f0-5c16e0d8b0f0` (hidden)
- `LocalDateTable_bb52ca70-df20-4d91-9844-6c38cafdae3d` (hidden)
- `LocalDateTable_33ee2408-0de3-453a-8be7-19ae0464a106` (hidden)
- `LocalDateTable_e8dac237-fd5a-4d9b-9204-34f7c7c1614e` (hidden)
- `LocalDateTable_23ed1ef8-29cf-47f4-a835-bd17dbf7e697` (hidden)
- `TimeSheet` (visible)
- `LocalDateTable_3b5a84fe-77f8-4ce7-bb0e-f7e698a1cd8d` (hidden)
- `LocalDateTable_bc7a9c7b-4241-4b06-a5a7-17141488f402` (hidden)
- `LocalDateTable_76de5c0f-fdbd-4eef-85d1-8fefbdab78e4` (hidden)
- `LocalDateTable_8cb67206-06e4-4576-a0f9-86bf0e5e927a` (hidden)
- `LocalDateTable_80987d1c-b7af-4ee3-b3f1-6bba3a33205a` (hidden)
- `LocalDateTable_a56a58cc-12fc-4faf-8d5e-041bbd2a9a88` (hidden)
- `LocalDateTable_c4478d45-4fcd-465b-af2c-9823d5e9af13` (hidden)
- `LocalDateTable_684a0b36-4d2d-46af-99a6-2f70ddbaff87` (hidden)
- `LocalDateTable_627de09f-2404-4a5d-8b13-2ba909ef93bc` (hidden)
- `LocalDateTable_a646b218-4827-4b35-b929-1df99f619b37` (hidden)
- `LocalDateTable_5a8b3f0e-f88b-4b5b-8bac-4ecc44161328` (hidden)
- `LocalDateTable_34b1c1dc-f46c-47ed-8054-52fdb95b65cb` (hidden)
- `LocalDateTable_c18a611e-126c-4378-8028-f900fa3ac131` (hidden)
- `LocalDateTable_31f40175-a696-4cda-ae88-9800906de27d` (hidden)
...
### Gleitender Durchschnitt für "_CountIncidents"
...
### _CountIncidents gesamt für statuscodename
...
### _Missing_Resolution_Notes_Rate
...
### _Estimated_Days_to_Clear_Backlog

```DAX
DIVIDE([_CountIncidents]*[_AVG TTS],24,0)
```

### _Customer_Support_Burden_Score

```DAX
MIN([_Repeat_Customer_Rate]*100,100)
```

### _High_Priority_Backlog_Percent
...
### _Cost_Per_Resolution

```DAX
([_AVG TTS] / 60) * 50
```

### _Revenue_Impact_VIP_Score
...
### _Problem_Pattern_Concentration
...
### _Agent_Idle_Time_Hours

```DAX
DIVIDE([_AVG TTS], [_Avg_Cases_Per_Agent], 0) * 24 - 1
```

### _KB_Usage_Effectiveness

```DAX
[_KB_Self_Service_Rate]
```

### _Macro_Script_Utilization_Level
